...
@router.get('/', response_model=List[Comment], responses={HTTP_404_NOT_FOUND: {'model': ErrorResponse}})
async def get_comments(post: Post = Depends(resolve_post)):
    """Get all comments from post"""
    pass


@router.post('/', response_model=Comment, responses={HTTP_403_FORBIDDEN: {'model': ErrorResponse},
...
@router.delete('/{comment_id}', responses={HTTP_403_FORBIDDEN: {'model': ErrorResponse},
                                           HTTP_404_NOT_FOUND: {'model': ErrorResponse}})
...
@router.patch('/{comment_id}', response_model=Comment, responses={HTTP_403_FORBIDDEN: {'model': ErrorResponse},
                                                                  HTTP_404_NOT_FOUND: {'model': ErrorResponse}})
...
@router.patch('/{comment_id}/{vote}', response_model=Comment, responses={HTTP_403_FORBIDDEN: {'model': ErrorResponse},
                                                                         HTTP_404_NOT_FOUND: {'model': ErrorResponse}})
...
@router.post('/{comment_id}/', response_model=Comment, responses={HTTP_403_FORBIDDEN: {'model': ErrorResponse},
                                                                  HTTP_404_NOT_FOUND: {'model': ErrorResponse}})
